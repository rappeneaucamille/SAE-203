...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 06 juin 2026 à 04:05
...
(0, 'test6@edu.univ-eiffel.fr', '$2y$10$GAbotU4fvikGFTaF1.94TuYqvXlSYMHGN8RkO9UYnkhBVAK8xiyRu', 'TEST6', 'test6', '0000000000', '2005-05-05', 'test6', 'test6', 'MMI1', 'TD1', 'TPA', NULL, NULL, 'En attente'),
...
(25001519, 'jeanne.dubois@edu.univ-eiffel.fr', '$2y$10$7Fti1i9.xZAZ6cxKNr.oXOnP0u.AwCrl1ZaVjO42Lb0LpSRQRYZRi', 'DUBOIS', 'Jeanne', '0123456789', '2007-11-29', 'Créteil', '9 Avenue du Général Leclerc, Créteil', 'MMI1', 'A1', 'TP1', 'Figma', 'Entreprise de jeux', 'Validé');
...
--
ALTER TABLE `maitre_stage`
  MODIFY `id_maitre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `recherche`
  MODIFY `id_recherche` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT pour la table `soutenance`
--
ALTER TABLE `soutenance`
  MODIFY `id_soutenance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
